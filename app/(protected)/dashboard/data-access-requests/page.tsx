...
export default function UserDataAccessRequestsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold">My Data Access Requests</h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="requests" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>My Data Access Requests</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="search" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Search My Requests</CardTitle>
            </CardHeader>
            <CardContent>
              <DataAccessRequestSearch onFiltersChange={handleFiltersChange} />
              <div className="mt-6">
